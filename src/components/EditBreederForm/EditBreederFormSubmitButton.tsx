...
import { selectName, selectDescription, selectFoundationDate, selectAddress, selectIsLoading, selectProfileImage } from '../../contexts/EditBreederContext/editBreederSelectors'
...
export default function EditBreederFormSubmitButton({ onSubmit }: EditBreederFormSubmitButton) {
  ...
  const handleSubmit = useCallback((e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    onSubmit({ name, address, description, foundationDate: new Date(foundationDate), files: [profileImage] })
  }, [onSubmit, name, address, description, foundationDate, profileImage])
